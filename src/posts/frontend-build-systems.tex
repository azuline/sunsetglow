...
Like meta-frameworks, build tools like \href{https://create-react-app.dev/}{Create React App} and
\href{https://vitejs.dev/}{Vite} provide preconfigured build systems for both production and
development, but they do not force a specialized application paradigm. They are suitable for generic
frontend applications.

Create React App provides a preconfigured Webpack and Babel-based build system. Vite provides a
preconfigured Rollup based-build system with support for both Babel and SWC via plugins. Vite also
does not bundle modules in the development server. This allows Vite to quickly start the development
server and have a near-constant time complexity Hot Module Replacement relative to application size.
